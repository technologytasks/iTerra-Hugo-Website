...
charge:
  ...
  body: ThermoVolt stores electricity as heat with near-100% electricity-to-heat
    conversion in the heating elements (resistive). The source doesn't matter —
    what matters is charging when electricity is abundant and releasing heat
    when it is needed. No inverter is required for the heating elements, and
...
safety:
  ...
  body: No flammable electrolyte. No pressurised gas. No fire risk. ThermoVolt
...
gateway:
  ...
  body1: The ThermoVolt controller monitors household electricity, PV output, and
  ...
  body2: As Pakistan's grid moves toward 60% renewables by 2030, dynamic tariffs
...
hero:
  ...
  subtitle: ThermoVolt stores electricity as heat in locally manufactured
    ...
    industrial process-heat batteriessss.
...
market:
  ...
  body1: Pakistan is in the midst of an unplanned solar revolution — 18 million
    rooftop systems installed not because of incentives, but because grid
    electricity became unaffordable. Renewables now supply 53% of electricity,
    with a target of 60% by 2030.
  body2: The result is a massive, stranded solar asset and an emerging dynamic
    tariff environment. Meanwhile, households and SMEs continue burning imported
    LPG and gas for water heating and cooking — the dominant energy end-uses.
